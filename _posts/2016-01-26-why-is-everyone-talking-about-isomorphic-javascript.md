...
* Most search engines don’t support client-side rendering when crawling websites. Even Google states that the [code must be simple enough for its crawlers to interpret properly]().
