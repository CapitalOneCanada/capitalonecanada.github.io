...
Here at Capital One, we are working hard to write “best in class” financial services applications for all users - including our users with disabilities. Over the past six months, I have had the opportunity to work on the Capital One Mobile for iPhone application. Specifically, I have been heavily involved in our user experience for VoiceOver (VO) users. VO, for the uninitiated, is Apple’s screen reader technology that can be used by blind and low vision users to get the most from their mobile devices.<!--more--> While a great benefit to the vision impaired community, all users can benefit from the VO experience. For example, I have personally used our VO experience on the Capital One Mobile for iPhone application to pay my credit bill while I was in the car and unable to look at the screen. _To learn more about VoiceOver and accessibility check out Apple’s documentation [here](http:/www.apple.com/accessibility/ios/voiceover/)._
